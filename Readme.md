...
- [`:17.06.2-3.9` (*Dockerfile*)](https://github.com/eea/eea.docker.jenkins.slave-dind/blob/17.06.2-3.9/Dockerfile) - Docker 17.06.2-ce, Docker-Compose 1.20.0, Swarm Client 3.9
